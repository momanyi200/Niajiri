										...
										$by_whom = ' by Admin';
											...
											<tr>
												...
												<span class="badge bg-success-light"><?php echo $amount_refund.$by_whom;?></span>
													...
													<?php }if($row['payment_status']==6 && $row['deposit_flag']==0 ){?>
													<span class="badge bg-success-light">
													<?php //echo (!empty($user_language[$user_selected]['lg_Payment_Completed'])) ? $user_language[$user_selected]['lg_Payment_Completed'] : $default_language['en']['lg_Payment_Completed']; 
													echo 'Payment to be Released'; 
													?>
													</span>
												<?php } if($row['payment_status']==6 && $row['deposit_flag']==1 ){ ?>
												  <span class="badge bg-success-light"> 
												  <?php  echo 'Payment Released';  ?> 
												  </span> 
												 <?php } 
