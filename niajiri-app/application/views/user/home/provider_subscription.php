                                ...
                                <div class="card-body">
									...
									if ($list['id'] != $my_subscribe['subscription_id'] && $list['fee']>0) {  
									 ...
									 <div class="row mt-2">
										...
										<?php } 								
										if(!empty($mpesa_option_status)) {    ?>
										<div class="col-6">
											<input class="form-check-input" type="radio" name="payment_type" id="mpesa"  value="mpesa">
											<img style="width:auto;" src="<?php echo  base_url() . "assets/img/mpesa.png"; ?>">
										</div>
										<?php }  ?><br />
						...
						<div class="modal-content">
							...
							<form action="#" method='post' id="mpesa_payment_submit" name="mpesa_payment_submit">
								...
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Mobile Number with country code" name='mob_no' id='mob_no' value="<?=$country_code.$mobileno?>" >
								</div>
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Amount" name='amount' id='amount' value="" readonly>
								</div>
							<input type="hidden" class="form-control form-control-lg" placeholder="" name='user_currency' id='user_currency' value="<?php echo $list['currency_code']; ?>">
							    
								 <input type="hidden" id="sub_id" value="">
 								<div class="text-center">
									<input type="button" name="mpesa_submit" value="PAY" id="mpesa_sub_chkout_submit">
								</div>
