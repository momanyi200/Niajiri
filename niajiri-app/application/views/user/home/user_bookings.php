                                        ...
                                        <div class="booking-det-info">
                                            ...
                                            <ul class="booking-details">
                                                <li>
                                                    ...
                                                    <span><?php echo (!empty($user_language[$user_selected]['lg_Booking_Date'])) ? $user_language[$user_selected]['lg_Booking_Date'] : $default_language['en']['lg_Booking_Date']; ?></span><?php echo   $date; ?>  
                                                </li>
                                                <li>
                                                    <?php  
                                                ...
                                                <li><span><?php echo (!empty($user_language[$user_selected]['lg_Amount'])) ? $user_language[$user_selected]['lg_Amount'] : $default_language['en']['lg_Amount']; ?></span>
                                                    <?php if($offerPrice != '' && $bookings['offersid'] > 0) {   
