            ...
            <div class="sorting-main">
                <div class="sorting">
                    <ul class="nav nav-tabs menu-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="services-tab" data-bs-toggle="tab" href="#services" role="tab" aria-controls="services" aria-selected="true"><img class="me-2" src="<?php echo base_url();?>assets/img/icon13.png" alt="img"><?php echo (!empty($user_language[$user_selected]['lg_Service'])) ? $user_language[$user_selected]['lg_Service'] : $default_language['en']['lg_Service']; ?></a>
                        </li>
                    </ul>
                </div>
                <div class="sort-by">
