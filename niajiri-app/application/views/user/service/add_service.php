        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <form method="post" enctype="multipart/form-data" autocomplete="off" id="add_service">
                    ...
                    <input class="form-control" type="hidden" name="username" id="username" value="<?php echo $this->session->userdata('id'); ?>">
                        ...
                        <div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									?>
									<label>
										<?php echo $stafftxt; ?> <span class="text-danger">*</span> 
										<a href="<?php echo base_url()?>add-staff" class="badge badge-secondary"><i class="fas fa-plus me-2"></i><?php echo (!empty($user_language[$user_selected]['lg_Add_Staff'])) ? $user_language[$user_selected]['lg_Add_Staff'] : $default_language['en']['lg_Add_Staff']; ?></a>
									</label>
