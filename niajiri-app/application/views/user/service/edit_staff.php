				...
				<div class="row">
					<div class="col">
						<div class="breadcrumb-title">
							<h2><?php echo (!empty($user_language[$user_selected]['lg_Edit_Staff'])) ? $user_language[$user_selected]['lg_Edit_Staff'] : $default_language['en']['lg_Edit_Staff']; ?></h2>
						</div>
					</div>
					<div class="col-auto float-end ms-auto breadcrumb-menu">
						<nav aria-label="breadcrumb" class="page-breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"><?php echo (!empty($user_language[$user_selected]['lg_Edit_Staff'])) ? $user_language[$user_selected]['lg_Edit_Staff'] : $default_language['en']['lg_Edit_Staff']; ?></li>
							</ol>
						</nav>
					</div>
				</div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <form id="update_staff" onSubmit='return submitDetailsForm()' action="<?php echo base_url()?>user/service/update_staff" method="POST" enctype="multipart/form-data">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<select class="form-control select" title="<?php echo $shptit; ?>" name="shop_id" id="shop_id">
											...
											if ($shp['id'] == $staff_details[0]['shop_id']) { ?> selected = "selected" <?php }   ?>><?php echo $shp['shop_name']?>
											</option>
											<?php } ?>
										</select>
									</div>
									<input type="hidden" id="shp_loc" value="">
									<input type="hidden" id="shp_lat" value="">
									<input type="hidden" id="shp_lng" value="">
								</div>
							</div>
						</div>
                    <div class="service-fields mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control  " type="text" name="firstname" id="firstname" value="<?php echo $staff_details[0]['first_name']; ?>" >
							 ...
							 <div class="col-lg-6">
                                <div class="form-group">
                                    <label>&nbsp;</label>
                                    <input class="form-control number staffmobile" type="text" name="mobileno" id="mobileno" value="<?php echo $staff_details[0]['contact_no']; ?>" maxlength="10">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control staffemail" type="text" name="email" id="email" value="<?php echo $staff_details[0]['email']; ?>">
							...
							<div class="form-group col-xl-3">
								...
								<input type="text" class="form-control  staff_datepicker" autocomplete="off" name="dob" value="<?php echo date("d-m-Y",strtotime($staff_details[0]['dob'])); ?>" id="dob">
							</div>
							<div class="form-group col-xl-3">
								...
								<br>
								<?php if($staff_details[0]['gender'] == 'Male') $mcheckcls = 'checked'; else $mcheckcls = '';
								if($staff_details[0]['gender'] == 'Female') $fcheckcls = 'checked';	else $fcheckcls = '';?>
								<label class="radio-inline">
								  <input type="radio" name="gender" value="Male" <?php echo $mcheckcls; ?>/>&nbsp;<?php echo (!empty($user_language[$user_selected]['lg_Male'])) ? $user_language[$user_selected]['lg_Male'] : $default_language['en']['lg_Male']; ?>
								</label>
								<label class="radio-inline">
								  <input type="radio" name="gender" value="Female"<?php echo $fcheckcls; ?> />&nbsp;<?php echo (!empty($user_language[$user_selected]['lg_Female'])) ? $user_language[$user_selected]['lg_Female'] : $default_language['en']['lg_Female']; ?>
								</label>								
							</div>
						</div>
					...
					<div class="service-fields mb-3"> 
						<label class="me-sm-2 float-start"> <?php echo (!empty($user_language[$user_selected]['lg_Staff_Work_Option'])) ? $user_language[$user_selected]['lg_Staff_Work_Option'] : $default_language['en']['lg_Staff_Work_Option']; ?>  <span class="text-danger">*</span> </label>
						<?php $hsarr = explode(",", $staff_details[0]['home_service']); ?>
						<div class="custom-control custom-control-xs custom-checkbox float-start  me-1 ms-1" >
							<input type="checkbox" class="custom-control-input servchkbox" name="home_service_shop" id="home_service_shop" value="1" <?php echo ($staff_details[0]['shop_service'] == 1)?'checked':'';?>>
						...
						<div class="custom-control custom-control-xs custom-checkbox float-start me-3 ms-3" >
							<input type="checkbox" class="custom-control-input servchkbox" name="home_service_home" id="home_service_home" value="2" <?php echo ($staff_details[0]['home_service'] == 2)?'checked':'';?>>
					...
					<div class="service-fields mb-3" id="homeservicemap">
						<div class="form-group">
							...
							<input type="hidden" name="selected_area" id="selected_area" value="<?php echo $staff_details[0]['home_service_area'] ?>">
				...
				<div class="tab-pane fade" id="service" role="tabpanel" aria-labelledby="service-tab">
                   <div class="service-fields mb-3">
					...
					<input type="hidden" id="staff_id_value" name="staff_id" value="<?php echo $staff_id; ?>">
