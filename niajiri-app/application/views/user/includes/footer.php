		...
		<div class="modal-content">
			...
			<div class="modal-body step-2" data-step="2">
				<div class="login-header">
					<h3><?php echo (!empty($user_language[$user_selected]['lg_OTP'])) ? $user_language[$user_selected]['lg_OTP'] : $default_language['en']['lg_OTP']; ?></h3>
					<p class="text-muted"><p class="text-muted"><?php echo (!empty($user_language[$user_selected]['lg_Verification_account'])) ? $user_language[$user_selected]['lg_Verification_account'] : $default_language['en']['lg_Verification_account']; ?></p></p>
				</div>
	...
	<div class="footer-top">
		<div class="container">
			...
			<?php } ?>
				...
				<div class="footer_navbar footermenu_mobile">
					<div class="container">
