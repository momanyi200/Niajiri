            ...
            <div class="col-lg-10">
				...
				<ul class="nav nav-tabs menu-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" id="basic-tab" data-bs-toggle="tab" href="#basic" role="tab" aria-controls="basic" aria-selected="true">Basic Information</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="service-tab" data-bs-toggle="tab" href="#service" role="tab" aria-controls="service" aria-selected="true">Service Information</a>
                    </li>
                </ul>		

                <form id="add_shop" onSubmit='return submitDetailsForm()' action="<?php echo base_url()?>freelances/add-shop" method="POST" enctype="multipart/form-data">
				 ...
				 <div class="tab-content" id="myTabContent">
					...
					<div class="service-fields mb-3">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									...
									<input class="form-control charonly" type="text" name="shop_title" id="shop_title" >
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label>&nbsp;</label>
								<input class="form-control number shopmobile" type="text" name="mobileno" id="mobileno" maxlength="10">
...
function submitDetailsForm()
{
	...
	if(shop_title.length == 0){
		$(".business_title").text('Please Enter asdasdShop Title');
		n=1;		
	}else{
		$(".business_title").text('');
	}
