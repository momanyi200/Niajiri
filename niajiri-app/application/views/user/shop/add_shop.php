    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!--onSubmit='return submitDetailsForms()'-->
                <form id="add_shop" method="POST" action="<?php echo base_url()?>add-shop" enctype="multipart/form-data">
					...
					<div class="service-fields mb-3">
						...
						<div class="col-lg-6">																		
                                <div class="form-group">
									...
									<span class="text-danger error sh_mobile" id="errexistno"></span>
