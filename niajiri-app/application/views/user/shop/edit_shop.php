    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!--onSubmit='return submitDetailsForm()'-->
                <form id="update_shop" action="<?php echo base_url()?>user/shop/update_shop" method="POST" enctype="multipart/form-data">
										...
										<?php for ($i = 0; $i < count($shop_image); $i++) {
                                            ...
                                            <li>
                                                <div class=" upload-images">
                                                    ...
                                                    <img class="loaded_img" alt="Service Image" src="<?php echo base_url() . $shop_image[$i]['shop_image']; ?>">
                                                </div>
                                            </li>
                                        <?php } ?>
                                    </ul>
