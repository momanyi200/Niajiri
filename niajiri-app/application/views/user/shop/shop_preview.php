...
$service_count = $this->db->where('shop_id', $shop['id'])->count_all_results('services s');
$this->db->where('status', 0);
$product_count = $this->db->where('shop_id', $shop['id'])->count_all_results('products');
    ...
    <div class="container">
				<div class="shop-header mt-30 mb-80">
                    <div class="shop-header-inner">
                        <div class="shop-logo">
                            <img class="h-100" src="<?php echo ($shop_image)?base_url().$shop_image:base_url().'assets/img/shop-logo.png'; ?>" alt="">
                        </div>
						...
						<!--	<a class="btn btn-secondary" href="<?php echo base_url() . 'all-services/' ?>"><?php echo $service_count; ?> Services</a>
