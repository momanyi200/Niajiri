...
$shoppay = $this->db->where('user_provider_id',$this->session->userdata('id'))->where("reason LIKE 'Add Shop'")->where('status','1')->get('moyasar_table')->num_rows();
            ...
            <div class="col-xl-9 col-md-8">
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-auto">
        				...
        				<?php } else { ?>
        					<h6><a href="<?php echo base_url()?>add-shop" class="btn btn-primary text-white"><i class="fas fa-plus me-2"></i><?php 
							echo (!empty($user_language[$user_selected]['lg_Add_Shop'])) ? $user_language[$user_selected]['lg_Add_Shop'] : $default_language['en']['lg_Add_Shop']; ?></a></h6>
        				<?php } ?>
        				</div>
                    ...
                    <div class="row mt-2" id="payment-types" style="display:none;">
                        ...
                        <?php }  ?>
						<?php if(!empty($mpesa_option_status)) { ?>
                        <div class="col-4">
                            <input class="form-check-input" type="radio" name="shop_payment_type" id="mpesa"  value="mpesa">
                            <img src="<?php echo base_url() . "assets/img/mpesa.png"; ?>" style="width:71px; height:60px;">
                        </div>
                        <?php }  ?>
						...
						<div class="modal-content">
							...
							<form action="#" method='post' id="mpesa_payment_submit" name="mpesa_payment_submit">
								...
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Mobile Number without country code" name='mob_no' id='mob_no' value="<?php echo $provider_details['mobileno']; ?>">
								</div>
								<div class="form-group">
									<label>Reference No: </label>
									<input type="text" readonly="" class="form-control form-control-lg" placeholder="Ref ID" name='ref_id' id='ref_id' value="174379">
								</div>
								<div class="form-group">
									<label>Amount to be paid :</label>
 									<input type="text"  class="form-control form-control-lg" readonly="" id="shop_fee" value="<?php echo settingValue('shop_fee'); ?>">
								</div>	
								<div class="form-group">	
									<input type="text"   class="form-control form-control-lg" readonly="" id="shop_currency" value="<?php echo $user_currency_code; ?>">  
								</div>	
