		...
		<div class="row">
			...
			<div class="col-xl-9 col-md-8">
				...
				<div id="orderList">
					...
					if (!empty($orders)) 
					{
						$ds_arr = array('1' => 'Order Placed', '2' => 'Order Confirmed', '3' => 'Shipped', '4' => 'Out for Delivery', '5' => 'Delivered', '6'=>'Cancelled By User', '7'=>'Cancelled By Provider','8'=>'Satisfied by user');
					 	$dsc = array('1' => 'warning', '2' => 'dark', '3' => 'primary', '4' => 'info', '5' => 'success', '6'=>'danger', '7'=>'danger','8'=>'success');
			...
			<?php  if($val['provider_payment']!='') { 
			?>
			<span class="badge badge-pill badge-prof bg-<?php if($val['cart_flag']==1) { echo $dsc[5]; }else{ echo $dsc[4]; } ?>"><?php echo $val['provider_payment']; ?></span>
			<?php  } ?>									
                                            </h3>
