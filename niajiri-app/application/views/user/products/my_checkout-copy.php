...
<div class="modal" id="mpesa_paymodal">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
							<form action="<?php echo base_url()?>home/test_c2b" method='post' id="mpesa_payment_submit" name="mpesa_payment_submit">
								<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Mobile Number" name='mob_no' id='mob_no'>
								</div>
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Amount" name='amount' id='amount'>
								</div>

								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Ref ID" name='ref_id' id='ref_id'>
								</div>

								<div class="text-center">
									<input type="submit" name="mpesa_submit" value="PAY">
								</div>
