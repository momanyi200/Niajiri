					 		...
					 		<div class="bookings" id="ol_<?php echo $val['id']?>">
					 			<div class="booking-list">
									...
									<?php
					 				...
					 				?>
					 				<div class="booking-action">
					 					<a href="javascript:void(0)" class="btn btn-sm bg-danger-light" onclick="satisfy_order('<?php echo $val['id']?>', '<?php echo $val['order_id']?>');">Satisfy on Delivery</a>
					 				</div>
					 				<?php
					 				} 
					 				?>
									<?php
					 				...
					 				?>
					 				<div class="booking-action">
					 					<span class="badge badge-pill badge-prof bg-success">Satisfied On Delivery </span>
					 				</div>
					 				<?php
					 				} 
					 				?>
