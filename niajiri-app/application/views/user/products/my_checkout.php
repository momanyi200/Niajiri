...
if ($type == 'user') {
	...
	$mobile_no = $this->db->select('*')->from('users u')->where("u.id", $userId)->get()->row_array();
                ...
                <div class="col-md-12 col-lg-8">
                    <div class="payment-method-wrapper">
						...
						<div class="mt-2" id="payment-types">
							...
							<input class="form-check-input" type="radio" name="order_payment_type" id="mpesa"  value="mpesa">
...
<div class="modal" id="mpesa_paymodal1">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="#" method='post' id="mpesa_payment_submit" name="mpesa_payment_submit">
								...
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Mobile Number without country code" name='mob_no' id='mob_no' value="<?=$mobile_no['country_code'].$mobile_no['mobileno']?>" >
									<p class="m-0 p-0"><small>Ex :2547xxxxxxxx</small></p>
								</div>
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="Amount" name='amount' id='amount' value="<?=get_gigs_currency($sub_product_total, $user_currency_code, $user_currency_code);?>" readonly>
								</div>
							<input type="hidden" class="form-control form-control-lg" placeholder="" name='user_currency' id='user_currency' value="<?=$user_currency_code?>">
								 <input type="hidden" id="order_id" value="<?php echo $order_id?>">
							<input type="hidden" name="select_billing" id="select_billing" value="" />
                            <input type="hidden" name="address_type"  id="address_type" value="">
								<div class="text-center">
									<input type="button" name="mpesa_submit" value="PAY" id="mpesa_prd_chkout_submit">
								</div>
