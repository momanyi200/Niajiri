						...
						<form id="add_category" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Is Featured?</label><br>
								 <label><input type="radio" name="is_featured" value="1">Yes</label>
								 <label><input type="radio" name="is_featured" value="2" checked>No</label>
							</div>
							<div class="mt-4">
								<?php if($user_role==1){?>
							...
							<?php }?>
								...
								<a href="<?php echo $base_url; ?>categories"  class="btn btn-danger">Cancel</a>
							</div>
						</form>
					</div>
				</div>
