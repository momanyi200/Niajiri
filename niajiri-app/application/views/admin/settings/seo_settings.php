							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<input type="text" data-role="tagsinput" class="input-tags form-control"  name="meta_keyword"  id="services" value="<?php if (isset($meta_keyword)) echo $meta_keyword; ?>">
									</div>
									<div class="form-group">
										<label>Meta Description  <span class="manidory">*</span></label>
										<textarea class="form-control"  name="meta_desc" id="meta_desc" value="<?php if (isset($meta_desc ))  ?>"><?php echo $meta_desc ;?></textarea>
									</div>
