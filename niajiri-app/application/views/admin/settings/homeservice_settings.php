                ...
                <div class="card">
                    <div class="card-body">
                        <div class="nav flex-column">
							...
							<a class="nav-link " data-bs-toggle="tab" href="#comm_service">Commission for service booking</a>
							<a class="nav-link " data-bs-toggle="tab" href="#comm_prd">Commission for product purchase</a>
                        ...
                        <form action="" method="post">
                            ...
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
							 ...
							 <div class="tab-content pt-0">
                                ...
                                <!-- Shops Fee -->
								   <!-- Shops Fee -->
                                <div id="comm_service" class="tab-pane">
                                    <div class="card mb-0">
                                        <div class="card-header">
                                            <h4 class="card-title">Comission for service booking(%)</h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Fee for new shop</label>
                                                <input type="text" class="form-control numbersOnly" id="book_service_fee_val" name="book_service_fee_val" value="<?php if(!empty($book_service_fee)){ echo $book_service_fee; } ?>" placeholder="Enter the new shop fee charge">
                                            </div>
                                ...
                                <!-- Shops Fee -->
								   ...
								   <!-- Shops Fee -->
                                <div id="comm_prd" class="tab-pane">
                                    <div class="card mb-0">
                                        <div class="card-header">
                                            <h4 class="card-title">Comission for Buying Products(%)</h4>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Fee for new shop</label>
                                                <input type="text" class="form-control numbersOnly" id="buy_product_fee_val" name="buy_product_fee_val" value="<?php if(!empty($buy_product_fee)){ echo $buy_product_fee; } ?>" placeholder="Enter the new shop fee charge">
                                            </div>
