					...
					<div class="card-body">
						<div class="dash-widget-header">
							...
							<div class="dash-widget-info">
								...
								if(!empty($services_count)){ echo $services_count;}else{ echo "0"; } ?></h4>
							...
							<table class="table table-center">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo wordwrap($list['service_title'], 100, '<br />', true); ?></td>
							...
							<table class="table table-center">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo wordwrap($service['service_title'], 100, '<br />', true); ?></td>
