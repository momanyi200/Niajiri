                            ...
                            <table class="table custom-table mb-0 w-100 payment_table">
                                ...
                                <tbody>
									...
									foreach ($lists as $rows) {										
										...
										$order_where = array('product_cart.status'=>1, 'shops.provider_id'=>$rows->id, 'product_order.payment_type' => 'MPESA-Mobile', 'product_cart.cart_flag'=>0);
										...
										$this->db->where_in('product_cart.delivery_status',[8,6]);						
										...
										echo'<tr>
											...
											<td align="center">'.settingValue('currency_option').''.$totamnt.'</td>';											
											echo '
											<td align="center">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form id="deposit_form" name="deposit_form">
			...
			<input type="radio"  id="mpesa_deposit" name="mpesa_deposit"  /> Select through MPESA Accont
      ...
      <div class="modal-footer">
      	<?php if($this->session->userdata('role') == 1) { ?>
        	<button type="button" id="confirm_btn_deposit" data-id="" class="btn btn-primary">Confirm & Pay</button>
    	<?php } ?>
