								...
								<div class="card">
									<div class="card-body">
										...
										<div class="pricing-card-price">
											...
											<h3 class="heading2 price"><?php echo settingValue('currency_option').$subscription_amount; ?></h3>
										...
										<?php if($this->session->userdata('role') == 1) { ?>
											<button type="button" sid="<?php echo $subscription['id']?>" id="chkdel_subcribe" class="btn btn-danger btn-block mt-2">Delete</button>
										<?php } ?>
									</div>
								</div>
							</div>
