...
if (!empty($this->session->userdata('provider_id')) && $this->session->userdata('provider_id')>0) {
	...
	<div class="content container-fluid">
		<div class="row">
			<div class="col-xl-8 offset-xl-2">
			  ...
			  <!-- Page Header -->
			  <div class="page-header cont-provider">
					<div class="row">
						<div class="col-sm-12">
				...
				<div class="card">
                    ...
                    <div class="service-fields mb-3 ">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select pro_change" name="username" id="username">
                            ...
                            <span class="error provider"></span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select" title="Staffs" name="staff_id[]" id="staff_id" multiple required="false">
                   ...
                   <div class="service-fields mb-3">
                    ...
                    <div class="submit-section">
                        <button class="btn btn-primary submit-btn" id="servicesubmit" type="submit" name="form_submit" value="submit"><?php echo $btntxt; ?></button>
                    </div>
                </form>
					</div>
				</div>
