							...
							<table class=" table table-hover table-center mb-0 payment_table">
								...
								foreach ($list as $rows) { 
									...
									if($rows['booking_id'] > 0) { 
										...
										$taxqry = $this->db->get('shops')->row_array(); 
								...
								<tr>
									...
									<td><?php echo settingValue('currency_option').($rows['amount']); ?></td> 
									...
									<td><?php echo settingValue('currency_option').($comAount); ?></td> 
									<td><?php echo settingValue('currency_option').($vatAmount); ?></td> 
