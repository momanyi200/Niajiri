<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-auto text-end">
					<a href="<?php echo $base_url; ?>product_units" class="btn btn-white add-button"><i class="fas fa-sync"></i></a>
					<a class="btn btn-white filter-btn" href="javascript:void(0);" id="filter_search">
						<i class="fas fa-filter"></i>
					</a>
					
					<a href="<?php echo $base_url; ?>manage-product-unit/0" class="btn btn-white add-button"><i class="fas fa-plus"></i></a>
		...
		<!-- Search Filter -->
		<form action="<?php echo base_url()?>product_units" method="post" id="filter_inputs">
					...
					<div class="row filter-row">
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
								<label>Unit</label>
								<input type="text" class="form-control" name="search[unit_name]" value="">
							</div>
						</div>
						<div class="col-sm-6 col-md-3">
							<div class="form-group">
							...
							<table class="table table-hover table-center mb-0 categories_table" >
								...
								<tbody>
									...
									if (!empty($list)) 
									{
										...
										foreach ($list as $val) 
										{
											$date=date(settingValue('date_format'), strtotime($val['created_on']));
											...
											<tr id="row_<?php echo $val['id']?>">
												...
												<td><?php echo  $date; ?></td>
												<td>
													<a href="<?php echo base_url()?>manage_product_unit/<?php echo $val['id']?>" class="btn btn-sm bg-success-light me-2"><i class="far fa-edit me-1"></i> Edit</a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure want to delete this Unit?.</p>
        <input type="hidden" id="hcat_id" value="">
        <input type="hidden" id="htable" value="product_units">
      </div>
