							...
							<table class="table table-hover table-center mb-0 service_table" >
                                ...
                                <tbody>
									...
									echo '<tr>
										...
										<td>'.$timeBase.'</td>
										<td><select class="form-control chngstatus" name="ser_status" data-id="'.$rows['id'].'" data-userid="'.$rows['userid'].'" data-providerid="'.$rows['providerid'].'" data-serviceid="'.$rows['serviceid'].'">
												<option value="">Select Status</option>';
