...
$route['admin/mpesa-payment-gateway'] = 'admin/settings/mpesa_payment_gateway';
...
$route['subscription-mpesa'] = 'user/subscription/mpesa_subscription_payment';
...
$route['staff-details/(:num)'] = 'admin/staffs/staff_details/$1';
...
$route['mpesa-callbackurl/(:any)']='user/appointment/mpesa_call_back/$1';
$route['mpesa_call_back_service_booking/(:any)'] = 'user/appointment/mpesa_call_back_service_booking/$1';
$route['prd-mpesa-callbackurl/(:any)']='user/products/prd_mpesa_call_back/$1';
$route['addshop-mpesa-callbackurl/(:any)']='user/shop/addshop_mpesa_call_back/$1';
$route['subscription-mpesa-callbackurl/(:any)']='user/subscription/subscription_mpesa_callbackurl/$1';
...
$route['api/send_push_notification1'] ='api/api/send_push_notification1';
...
$route['api/book-service-mpesa-pay'] = 'api/api/booking_service_mpesa_payment';
$route['api/book-service-mpesa-pay-status'] = 'api/api/booking_service_mpesa_payment_status';
$route['api/buy-product-mpesa-payment'] = 'api/api/buyProduct_mpesa_payment';
$route['api/buy-product-mpesa-payment-status'] = 'api/api/buyProduct_mpesa_payment_status';
$route['api/provider-subscription-mpesa-payment'] = 'api/api/provider_subscription_mpesa_payment';
$route['api/provider-subscription-mpesa-payment-status'] = 'api/api/provider_subscription_mpesa_payment_status';
$route['api/provider-add-shop-mpesa_pay-status'] = 'api/api/provider_add_shop_mpesa_payment_status';
$route['api/user-order-list-satisfy'] = 'api/api/user_order_list_changeSatisfy';
$route['api/mpesa_mobile_validation'] = 'api/api/mpesa_mobile_validation_post';
$route['api/provider-add-shop-mpesa_pay'] = 'api/api/provider_add_shop_mpesa_payment';
$route['api/home'] = 'api/api/home';
