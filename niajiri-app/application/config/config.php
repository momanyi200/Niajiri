...
{
	if(stripos($_SERVER["REQUEST_URI"],'/user/appointment/mpesa_call_back_service_booking') !==false)
	{
		 $config['csrf_protection'] = FALSE;
		 $cf=10;
	}
	elseif(stripos($_SERVER["REQUEST_URI"],'/user/products/prd_mpesa_call_back') !==false)
	{
		 $config['csrf_protection'] = FALSE;
		 $cf=11;
	}
	elseif(stripos($_SERVER["REQUEST_URI"],'/user/subscription/subscription_mpesa_callbackurl') !==false)
	{
		 $config['csrf_protection'] = FALSE;
		 $cf=12;
	}
	elseif(stripos($_SERVER["REQUEST_URI"],'/user/shop/addshop_mpesa_call_back') !==false)
	{
		 $config['csrf_protection'] = FALSE;
		 $cf=13;
	}
	elseif(stripos($_SERVER["REQUEST_URI"],'/paytabs_success') !==false)
	{
		 $config['csrf_protection'] = FALSE;
		 $cf=1;
	}
