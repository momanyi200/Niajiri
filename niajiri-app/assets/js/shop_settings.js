...
$('#myshop_stripe_payment').on('click', function(e) {
	...
	$("#mpesa_submit_id").on('click', function(e){
        ...
        e.preventDefault();
			...
			alert(csrf_token); 
 				$.ajax({
				 data: {status:'initiate',amount: shop_fees,csrf_token_name:csrf_token,mobile_no:mob_no,ref_id: ref_id},
				 url: base_url+'user/shop/mpesa_shop_payment',
				 type: 'POST',	
				 success: function(response){
